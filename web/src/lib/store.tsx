...
const DICT = {
  bn: {
    ...
    'admin.scopeNone': 'কোনো ব্যাচ নির্ধারণ করা হয়নি',
    'admin.scopeGapWarning': 'এই অ্যাডমিনের ব্যাচগুলো ধারাবাহিক নয়। সংরক্ষণ করলে শুরু থেকে শেষ পর্যন্ত সব ব্যাচ যুক্ত হয়ে যাবে।',
    ...
    'claims.nav': 'পরিচয় যাচাই',
    'claims.title': 'পরিচয় যাচাই',
    'claims.intro': 'যাঁরা মোবাইল নম্বর দিয়ে নিজের নাম দাবি করেছেন — তাঁরা সত্যিই ওই ব্যাচের কি না, সেটি এখানে নিশ্চিত করুন।',
    'claims.waiting': 'যাচাইয়ের অপেক্ষায়',
    'claims.verified': 'যাচাই হয়েছে',
    'claims.rejected': 'বাতিল',
    'claims.verify': 'যাচাই করুন',
    'claims.claimedOn': 'দাবির তারিখ',
    'claims.hasRegistration': 'নিবন্ধন জমা আছে',
    'claims.alsoRegistered': 'এই ব্যক্তি রিইউনিয়নের জন্য নিবন্ধনও জমা দিয়েছেন। পরিচয় যাচাই করলেও নিবন্ধনটি আলাদাভাবে অনুমোদন করতে হবে।',
    'claims.noRegistration': 'এই ব্যক্তি এখনো রিইউনিয়নের জন্য নিবন্ধন করেননি। পরিচয় যাচাই তাতেই আটকে থাকে না।',
    'claims.settled': 'এই দাবির সিদ্ধান্ত আগেই হয়ে গেছে।',
    'admin.settledMember': 'এই সদস্যের সিদ্ধান্ত আগেই হয়ে গেছে।',
    'admin.settledPayment': 'এই পেমেন্ট আগেই নিশ্চিত হয়েছে।',
    'admin.askSuper': 'পরিবর্তন করতে সুপার অ্যাডমিনের সাথে যোগাযোগ করুন।',
    'admin.override': 'সিদ্ধান্ত পরিবর্তন করুন',
    'admin.overrideWarn': 'এটি আগের সিদ্ধান্ত বদলে দেবে এবং নিরীক্ষা তালিকায় লেখা থাকবে।',
  ...
  en: {
    ...
    'admin.scopeNone': 'No batches assigned',
    'admin.scopeGapWarning': "This admin's batches are not consecutive. Saving will assign every batch from first to last.",
    ...
    'admin.andMore': 'more',
    'claims.nav': 'Identity',
    'claims.title': 'Identity verification',
    'claims.intro': 'People who have claimed their name with a mobile number — confirm here whether they really are of that batch.',
    'claims.waiting': 'Waiting to be verified',
    'claims.verified': 'Verified',
    'claims.rejected': 'Rejected',
    'claims.verify': 'Verify',
    'claims.claimedOn': 'Claimed on',
    'claims.hasRegistration': 'Registration sent in',
    'claims.alsoRegistered': 'This person has also sent in a registration for the reunion. Verifying who they are does not approve it — that is a separate decision on the Members queue.',
    'claims.noRegistration': 'This person has not registered for the reunion. Verifying who they are does not depend on it.',
    'claims.settled': 'This claim has already been decided.',
    'admin.settledMember': 'This member has already been decided.',
    'admin.settledPayment': 'This payment is already confirmed.',
    'admin.askSuper': 'Ask a super admin to change it.',
    'admin.override': 'Change this decision',
    'admin.overrideWarn': 'This overturns the earlier decision and is recorded in the audit trail.',
